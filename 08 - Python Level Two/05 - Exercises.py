...
#my_cards = [(s,r) for s SUITE for r in RANKS]
...
#create a new deck and split it
d = Deck()
d.shuffle()
...
while user.still_has_cards() and computer.still_has_cards():
    ...
    if c_card[1] == p_card[1]:
        ...
        #index para achar onde está o index do que esta passando como parametro(procurando)
...
print("gamer over, number of rounds: "+str(total_rounds))
